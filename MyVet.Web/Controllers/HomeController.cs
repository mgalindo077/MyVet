...
namespace MyVet.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Create(PetViewModel model)
        {
            ...
            model.PetType = await _dataContext.PetTypes.FindAsync(model.PetTypeId);
            return View(model);
        }
        ...
        public async Task<IActionResult> Assing(int? id)
        {
            ...
            var owner = await _dataContext.Owners.FirstOrDefaultAsync(o => o.User.UserName.ToLower() == User.Identity.Name.ToLower());
            if (owner == null)
            {
                return NotFound();
            }
            ...
            model.Pets = _combosHelper.GetComboPets(owner.Id);
            return View(model);
        }
